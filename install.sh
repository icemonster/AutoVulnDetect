...
then
    ...
    wget https://github.com/BinaryAnalysisPlatform/bap/releases/download/v1.6.0/{bap,libbap,libbap-dev}-1.6.0-2.x86_64.rpm
    sudo rpm -i {bap,libbap,libbap-dev}-1.6.0-2.x86_64.rpm
else
